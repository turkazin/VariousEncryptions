# 3/28/2023
# Text encypting and decrypting code by using Vigenere cipher
# On Kazakh language
...
flag = ''
while True:
    # Means: To encrypt enter "cip", to decrypt enter "decip", to exit enter "exit".
    flag = input("Шифрлау үшін (cip), ал дешифрлау үшін (decip) енгізіңіз, ал шығу үшін (exit): ").replace(' ', '')
    if flag == 'cip' or flag == 'decip':
        break
    elif flag == 'exit':
        exit()
    print("Енгізілген мән қате! Қайталаңыз!") # Means: Entered value is incorrect! Repeat!
